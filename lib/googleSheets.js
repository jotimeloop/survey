...
export async function saveFamilyToSheet(data) {
  ...
  if (!client) {
    throw new Error(
      'Google Sheets integration is not configured. Please add GOOGLE_SHEET_ID, GOOGLE_SERVICE_ACCOUNT_EMAIL, and GOOGLE_PRIVATE_KEY to your environment variables.'
    );
  }
